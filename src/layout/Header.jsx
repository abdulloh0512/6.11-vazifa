...
function Header() {
  ...
  return (
    <nav className="py-4  px-5 md:px-24  lg:px-40 fixed z-10  w-full border-b border-grayshade-300">
      <img
      ...
      <div className="w-full z-99 flex items-center justify-between">
        ...
        <div className="flex items-center justify-between">
          <Link className="relative lg:mx-6 md:mx-4 mx-3" to={"/checkout"}>
            ...
            <img width={35} height={35} src="../basket.png" alt="" />
          </Link>
          <ThemeSwitcher />
          <Link
            className="lg:mx-6 md:mx-4 mx-3"
            to={"https://github.com/abdulloh0512/6-11-vazifa"}
            target="_blank"
          >
